...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(BostonHousing}\SpecialCharTok{$}\NormalTok{chas)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(BostonHousing}\SpecialCharTok{$}\NormalTok{crim)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(BostonHousing}\SpecialCharTok{$}\NormalTok{rm)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{_main_files/figure-latex/task_2_0-1.pdf}
...
\includegraphics{_main_files/figure-latex/task_2_1-1.pdf}
...
\includegraphics{_main_files/figure-latex/task_2_2-1.pdf}
...
\includegraphics{_main_files/figure-latex/task_2_3-1.pdf}
...
\includegraphics{_main_files/figure-latex/task_3-1.pdf}
...
\NormalTok{trainIndex }\OtherTok{\textless{}{-}} \FunctionTok{createDataPartition}\NormalTok{(BostonHousing}\SpecialCharTok{$}\NormalTok{medv, }\AttributeTok{p =}\NormalTok{ .}\DecValTok{7}\NormalTok{, }\AttributeTok{list =} \ConstantTok{FALSE}\NormalTok{)}
\NormalTok{trainData }\OtherTok{\textless{}{-}}\NormalTok{ BostonHousing[trainIndex,]}
\NormalTok{testData }\OtherTok{\textless{}{-}}\NormalTok{ BostonHousing[}\SpecialCharTok{{-}}\NormalTok{trainIndex,]}
\NormalTok{model }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(medv }\SpecialCharTok{\textasciitilde{}}\NormalTok{ nox }\SpecialCharTok{+}\NormalTok{ rm, }\AttributeTok{data =}\NormalTok{ trainData)}
\NormalTok{testData}\SpecialCharTok{$}\NormalTok{predicted\_MEDV }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(model, testData)}
\NormalTok{testData}\SpecialCharTok{$}\NormalTok{pred\_interval }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(model, testData, }\AttributeTok{interval =} \StringTok{"prediction"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{_main_files/figure-latex/task_5_p-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{RMSE}\NormalTok{(testData}\SpecialCharTok{$}\NormalTok{medv, augmented\_data}\SpecialCharTok{$}\NormalTok{.fitted)}
\end{Highlighting}
\end{Shaded}
