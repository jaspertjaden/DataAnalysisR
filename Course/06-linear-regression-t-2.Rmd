...
## Further resources
::: {.resources}
- [Multiple Linear Regression | A Quick Guide (Examples)](https://www.scribbr.com/statistics/multiple-linear-regression/): This article provides an overview of multiple linear regression, its assumptions, how to perform it, and how to interpret the results.
- [Lesson 5: Multiple Linear Regression | STAT 501](https://online.stat.psu.edu/stat501/lesson/5): This lesson covers the basics of multiple linear regression, including matrix notation, model assumptions, hypothesis testing, and R-squared.
- [Multiple Linear Regression in R | R Tutorial 5.3 | MarinStatsLectures](https://www.youtube.com/watch?v=q1RD5ECsSB0): This video tutorial shows how to fit a multiple linear regression model in R, produce summaries, and interpret the coefficients.
- [Mastering Multiple Linear Regression: A Comprehensive Guide](https://www.analyticsvidhya.com/blog/2021/05/multiple-linear-regression-using-python-and-scikit-learn/): This article explains how to perform multiple linear regression using Python and scikit-learn, with examples and code snippets.
