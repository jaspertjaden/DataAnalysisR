...
Up to now, we exclusively talked about the coefficient block. We will return to the "Call" [next session](#lin-a) and to the "Residuals" later in this session. For now let us focus on the bottom block in the output.
...
In the [next session](#lin-a) we will return to our NBA data and try to apply everything that we have learned over the last sessions.
