...
points a player makes per game and the salary he receives in [session 2](#eda-1). In
[session 4](#dags-1) we also built a DAG that reflects our assumptions about the data
...
process. In the [session 10](#med) we will see, how we can come up with a different
